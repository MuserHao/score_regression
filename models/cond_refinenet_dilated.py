...
class CondRefineNetDilated(nn.Module):
    def __init__(self, config, input_channels, out_channels):
        super().__init__()
        ...
        self.end_conv = nn.Conv2d(ngf, out_channels, 3, stride=1, padding=1)  # changed output channel
    ...
    def forward(self, x, y):
        ...
        # print(layer1.shape);print(layer2.shape);print(layer3.shape);print(layer4.shape)
        ...
        # print(ref1.shape);print(ref2.shape);print(ref3.shape);print(output.shape)
