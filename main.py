...
def parse_args_and_config():
    ...
    parser.add_argument('--runner', type=str, default='BaselineRunner', help='The runner to execute')
    parser.add_argument('--config', type=str, default='default.yml',  help='Path to the config file')
    ...
    parser.add_argument('--save', action='store_true', help='Whether to save all output images')
